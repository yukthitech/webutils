...
public class EmailService
{
	...
	*/
	...
	/**
	 * Process the specified freemarker template string with specified context.
	 * @param name Name of the template used for debugging.
	 * @param templateString Template string to be processed.
	 * @param context Context to be used for processing.
	 * @return Processed result.
	 */
	private String processTemplate(String name, String templateString, Object context)
	{
		try
		{
		...
		{
			throw new IllegalStateException("An exception occurred while building " + name + " of template: " + name, ex);
		}
	}
	...
	private Message buildMessage(EmailServerSettings settings, EmailData emailData, Object context) throws AddressException, MessagingException
	{
		...
		//set the subject
		String subject = processTemplate(emailData.getTemplateName() + ".subject", emailData.getSubjectTemplate(), context);
		...
		String content = processTemplate(emailData.getTemplateName() + ".content", emailData.getContentTemplate(), context);
