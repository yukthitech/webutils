...
{
	/**
	 * Interval in millis at which this method should be executed. 
	 * @return interval at which method should be executed.
	 */
	public long interval();
	
	/**
	 * Initial delay in millis after which first time execution should happen after startup. Negative value indicates
