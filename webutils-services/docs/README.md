...
| [services.md](./services.md) | Controllers, entities, repos, models, search, LOV, OTP, responses |
| [ui-widgets.md](./ui-widgets.md) | Vue pages, form/search/LOV widgets, SPA shells, static assets |
...
3. UI listings always use search queries + `yk-search-form` / `yk-search-results`.
