...
dialogComponents['yk-model-form-dialog'] = {
	...
	"created": function() {
		$restService.fetchModelDef(this.modelName, $.proxy(this.setFormData, this));
				...
				<div class="modal-dialog webutils-modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-footer" style="padding: 5px;">
							<button type="button" id="webutils-alert-ok-btn" class="webutils-btn-primary" @click="closeAlert">Okay</button>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="modal-dialog webutils-modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="form-group">
						    ...
						    <input type="text" id="webutils-input-value" class="form-control" v-model="inputValue">
						</div>

						<!-- Footer -->
						<div class="modal-footer" style="padding: 5px;">
							<button type="button" id="webutils-input-ok-btn" class="webutils-btn-primary" @click="closeInput(true)">Okay</button>
							<button type="button" id="webutils-input-cancel-btn" class="webutils-btn-cancel" @click="closeInput(false)">Cancel</button>
						</div>
					</div>
				</div>
			</div>
