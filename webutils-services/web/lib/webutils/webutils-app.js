...
export function addDefaultComponents(app) {
	...
	app.component('yk-payment-checkout', ykPaymentCheckout);
	app.component('yk-status-badge', ykStatusBadge);
}
...
export function newVueApp(vueData)
{
	var defData = {
		"mounted": function() {
			console.log("newVueApp.mounted is invoked..");
